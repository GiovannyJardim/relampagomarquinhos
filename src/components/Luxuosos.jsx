...
export default function Luxuosos() {
  return (
    <div className="bg-dark-green p-12 max-lg:rounded-b-lg lg:rounded-r-lg">
        ...
        <a className="font-lexend mb-7 bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-dark-green border-2 border-offwhitebg hover:bg-dark-green hover:text-offwhite" href="https://www.webmotors.com.br/carros-de-luxo" target="_blank">Ver mais</a>
    </div>
  )
}
